...
curl https://raw.githubusercontent.com/scgerkin/C964_Capstone/main/api/docker-compose.yaml > /home/ec2-user/docker-compose.yaml
curl -L "https://github.com/docker/compose/releases/download/1.27.4/docker-compose-$(uname -s)-$(uname -m)" -o /usr/local/bin/docker-compose
chmod +x /usr/local/bin/docker-compose
curl https://raw.githubusercontent.com/scgerkin/C964_Capstone/main/api/dx-classifier.service > /home/ec2-user/dx-classifier.service
curl https://raw.githubusercontent.com/scgerkin/C964_Capstone/main/api/start-dx-classifier.sh > /home/ec2-user/start-dx-classifier.sh
